...
class InforCompassJdbcSourceAcceptanceTest extends JdbcSourceAcceptanceTest {

  private static final Logger LOGGER = LoggerFactory.getLogger(InforCompassJdbcSourceAcceptanceTest.class);
  ...
  public String getDriverClass() {
    return InforCompassSource.DRIVER_CLASS;
  }
